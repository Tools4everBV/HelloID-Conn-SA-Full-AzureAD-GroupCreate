<!-- Description -->
## Description
This HelloID Service Automation Delegated Form can create Azure groups. The following options are available:
 1. Enter a name for the Group
 3. The displayname, mail, mailnickname and description are generated
 4. Optional, change the generated displayname, mailnickname or description if needed
 5. Optional, select owner(s)
 6. Optional, select member(s)
 7. After confirmation the group is created (and the owner(s) and member(s) are added)
...
By using this connector you will have the ability to create an Azure AD Group.
...
### Powershell data source 'Azure-AD-Group-Create-generate-table-Users'

### Powershell data source 'Azure-AD-Group-Create-check-names'

### Delegated form task 'Azure-AD-Group-Create'

## Getting help
_If you need help, feel free to ask questions on our [forum](https://forum.helloid.com/forum/helloid-connectors/service-automation/190-helloid-sa-azure-ad-create-group)_
